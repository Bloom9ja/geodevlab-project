...
|----|---------|----------|--------|
| D01 | Odeda LGA boundary (Admin 2) | HDX COD-AB Nigeria | https://data.humdata.org/dataset/cod-ab-nga |
...
| D04 | Road network | OpenStreetMap, via HOTOSM Nigeria Roads export | https://data.humdata.org/dataset/hotosm_nga_roads |
...
Exact download dates, versions, CRS, and any clipping steps applied will be recorded in `docs/data-sources.md` before analysis begins. Note: D04 needs a fresh national pull, clipped to Odeda; this is the hardest dataset in this list and the one being tested first, since without usable road data the road-based version of this question doesn't work at all. Note also that D05 is a 2025 beta release (R2024B) per WorldPop's own disclaimer; more current than the older 2020 constrained dataset, but still subject to revision.
...
- [ ] Road network freshly downloaded and clipped to Odeda, with tag completeness checked
